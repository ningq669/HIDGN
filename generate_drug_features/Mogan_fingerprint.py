...
def get_config():
    ...
    parse.add_argument('-feature_save_path', '--feature_save_path_topofallfeature', type=str, nargs='?', default="../Data/KIBA/drug_features/Mogan_features.xlsx",help="setting the dataset:KIBA,davis,BindingDB and DrugBank")
